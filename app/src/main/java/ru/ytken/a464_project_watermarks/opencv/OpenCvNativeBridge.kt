package ru.ytken.a464_project_watermarks.opencv
...
import ru.ytken.a464_project_watermarks.*
import ru.ytken.a464_project_watermarks.toBitmap
import ru.ytken.a464_project_watermarks.toMat
...
class OpenCvNativeBridge {
    ...
    private fun sortPoints(src: Array<Point>): Array<Point> {
        ...
        val sumComparator: java.util.Comparator<Point> = Comparator<Point> { lhs, rhs -> (lhs.y + lhs.x).compareTo(rhs.y + rhs.x) }
        val diffComparator: java.util.Comparator<Point> = Comparator<Point> { lhs, rhs -> (lhs.y - lhs.x).compareTo(rhs.y - rhs.x) }
